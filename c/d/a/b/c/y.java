...
public final class y {
    ...
    public final synchronized int a() {
        ...
        if (this.f1549b == 0) {
            try {
                packageInfo = c.a(this.f1548a).e("com.google.android.gms", 0);
            ...
            if (packageInfo != null) {
                this.f1549b = packageInfo.versionCode;
            }
        }
        return this.f1549b;
    }
    ...
    public final synchronized int b() {
        /*
            r5 = this;
            monitor-enter(r5)
            int r0 = r5.f1550c     // Catch:{ all -> 0x007f }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r5)
            return r0
        L_0x0007:
            android.content.Context r0 = r5.f1548a     // Catch:{ all -> 0x007f }
            android.content.pm.PackageManager r0 = r0.getPackageManager()     // Catch:{ all -> 0x007f }
            android.content.Context r1 = r5.f1548a     // Catch:{ all -> 0x007f }
            com.google.android.gms.common.n.b r1 = com.google.android.gms.common.n.c.a(r1)     // Catch:{ all -> 0x007f }
            ...
            return r3
        L_0x0028:
            boolean r1 = com.google.android.gms.common.util.k.h()     // Catch:{ all -> 0x007f }
            r2 = 1
        ...
        L_0x006a:
            ...
            boolean r0 = com.google.android.gms.common.util.k.h()     // Catch:{ all -> 0x007f }
        ...
        L_0x007f:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: c.d.a.b.c.y.b():int");
    }
}
