...
class d extends i {
    ...
    private static Class<?> f558b = null;

    /* renamed from: c  reason: collision with root package name */
    private static Constructor<?> f559c = null;

    /* renamed from: d  reason: collision with root package name */
    private static Method f560d = null;

    /* renamed from: e  reason: collision with root package name */
    private static Method f561e = null;
    ...
    private static boolean j(Object obj, String str, int i, boolean z) {
        m();
        try {
            return ((Boolean) f560d.invoke(obj, new Object[]{str, Integer.valueOf(i), Boolean.valueOf(z)})).booleanValue();
    ...
    private static Typeface k(Object obj) {
        m();
        try {
            Object newInstance = Array.newInstance(f558b, 1);
            Array.set(newInstance, 0, obj);
            return (Typeface) f561e.invoke((Object) null, new Object[]{newInstance});
        } catch (IllegalAccessException | InvocationTargetException e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    private static Object n() {
        m();
        try {
            return f559c.newInstance(new Object[0]);
    ...
    public android.graphics.Typeface c(android.content.Context r4, android.os.CancellationSignal r5, b.d.h.b.f[] r6, int r7) {
        /*
            r3 = this;
            int r0 = r6.length
            r1 = 0
        ...
        L_0x0067:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: b.d.e.d.c(android.content.Context, android.os.CancellationSignal, b.d.h.b$f[], int):android.graphics.Typeface");
    }
}
