...
public final class o {
    ...
    static void a(com.google.android.gms.measurement.internal.m3 r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x0031:
            ...
            r1 = r13
        L_0x0033:
            com.google.android.gms.measurement.internal.k3 r2 = r14.w()     // Catch:{ all -> 0x00e2 }
            java.lang.String r3 = "Error querying for table"
            r2.c(r3, r10, r0)     // Catch:{ all -> 0x00e2 }
        ...
        L_0x00bc:
            ...
            com.google.android.gms.measurement.internal.k3 r1 = r14.w()     // Catch:{ SQLiteException -> 0x00d7 }
            ...
            r1.c(r2, r10, r0)     // Catch:{ SQLiteException -> 0x00d7 }
        L_0x00d1:
            return
        L_0x00d2:
            r0 = move-exception
        ...
        L_0x00d7:
            r0 = move-exception
            com.google.android.gms.measurement.internal.k3 r1 = r14.r()
        ...
        L_0x00f3:
            goto L_0x00f2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.o.a(com.google.android.gms.measurement.internal.m3, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    static void b(m3 m3Var, SQLiteDatabase sQLiteDatabase) {
        if (m3Var != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                m3Var.w().a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                m3Var.w().a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                m3Var.w().a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                m3Var.w().a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
