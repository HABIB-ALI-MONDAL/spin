...
class d {
    ...
    public byte[] c(byte[] bArr) {
        ...
        for (byte b3 : bArr) {
            ...
            i += 8;
            while (i >= 8) {
                aVar = aVar.f3210a[(b2 >>> (i - 8)) & 255];
                if (aVar.f3210a == null) {
                    byteArrayOutputStream.write(aVar.f3211b);
                    i -= aVar.f3212c;
                    aVar = this.f3209a;
                } else {
                    i -= 8;
        ...
        while (i > 0) {
            a aVar2 = aVar.f3210a[(b2 << (8 - i)) & 255];
            if (aVar2.f3210a != null || aVar2.f3212c > i) {
                break;
            }
            byteArrayOutputStream.write(aVar2.f3211b);
            i -= aVar2.f3212c;
            aVar = this.f3209a;
        }
    ...
    public int e(ByteString byteString) {
        ...
        for (int i = 0; i < byteString.size(); i++) {
            j += (long) f3207c[byteString.getByte(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
}
