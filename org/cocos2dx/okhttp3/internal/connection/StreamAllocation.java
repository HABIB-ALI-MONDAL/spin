...
public final class StreamAllocation {
    ...
    private org.cocos2dx.okhttp3.internal.connection.RealConnection findHealthyConnection(int r4, int r5, int r6, int r7, boolean r8, boolean r9) {
        /*
            r3 = this;
        L_0x0000:
    ...
    public boolean hasMoreRoutes() {
        /*
            ...
            org.cocos2dx.okhttp3.internal.connection.RouteSelector$Selection r0 = r1.routeSelection
            if (r0 == 0) goto L_0x000e
            boolean r0 = r0.hasNext()
            if (r0 != 0) goto L_0x0019
        L_0x000e:
            org.cocos2dx.okhttp3.internal.connection.RouteSelector r0 = r1.routeSelector
            boolean r0 = r0.hasNext()
        ...
        L_0x001a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.cocos2dx.okhttp3.internal.connection.StreamAllocation.hasMoreRoutes():boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x001c, code lost:
        if (r7 != org.cocos2dx.okhttp3.internal.http2.ErrorCode.CANCEL) goto L_0x001e;
     */
    ...
    public void streamFailed(java.io.IOException r7) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r7 instanceof org.cocos2dx.okhttp3.internal.http2.StreamResetException     // Catch:{ all -> 0x0062 }
            r2 = 0
            r3 = 0
            r4 = 1
            if (r1 == 0) goto L_0x0021
            org.cocos2dx.okhttp3.internal.http2.StreamResetException r7 = (org.cocos2dx.okhttp3.internal.http2.StreamResetException) r7     // Catch:{ all -> 0x0062 }
            org.cocos2dx.okhttp3.internal.http2.ErrorCode r7 = r7.errorCode     // Catch:{ all -> 0x0062 }
            org.cocos2dx.okhttp3.internal.http2.ErrorCode r1 = org.cocos2dx.okhttp3.internal.http2.ErrorCode.REFUSED_STREAM     // Catch:{ all -> 0x0062 }
            if (r7 != r1) goto L_0x001a
            int r7 = r6.refusedStreamCount     // Catch:{ all -> 0x0062 }
            int r7 = r7 + r4
            r6.refusedStreamCount = r7     // Catch:{ all -> 0x0062 }
            if (r7 <= r4) goto L_0x0043
            goto L_0x001e
        L_0x001a:
            org.cocos2dx.okhttp3.internal.http2.ErrorCode r1 = org.cocos2dx.okhttp3.internal.http2.ErrorCode.CANCEL     // Catch:{ all -> 0x0062 }
            if (r7 == r1) goto L_0x0043
        L_0x001e:
            r6.route = r3     // Catch:{ all -> 0x0062 }
            goto L_0x0041
        L_0x0021:
            org.cocos2dx.okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0062 }
            if (r1 == 0) goto L_0x0043
            boolean r1 = r1.isMultiplexed()     // Catch:{ all -> 0x0062 }
            if (r1 == 0) goto L_0x002f
            boolean r1 = r7 instanceof org.cocos2dx.okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x0062 }
            if (r1 == 0) goto L_0x0043
        L_0x002f:
            org.cocos2dx.okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0062 }
            int r1 = r1.successCount     // Catch:{ all -> 0x0062 }
            if (r1 != 0) goto L_0x0041
            org.cocos2dx.okhttp3.Route r1 = r6.route     // Catch:{ all -> 0x0062 }
            if (r1 == 0) goto L_0x001e
            if (r7 == 0) goto L_0x001e
            org.cocos2dx.okhttp3.internal.connection.RouteSelector r5 = r6.routeSelector     // Catch:{ all -> 0x0062 }
        ...
        L_0x0044:
            org.cocos2dx.okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0062 }
            java.net.Socket r7 = r6.deallocate(r7, r2, r4)     // Catch:{ all -> 0x0062 }
            org.cocos2dx.okhttp3.internal.connection.RealConnection r2 = r6.connection     // Catch:{ all -> 0x0062 }
            if (r2 != 0) goto L_0x0054
            boolean r2 = r6.reportedAcquired     // Catch:{ all -> 0x0062 }
